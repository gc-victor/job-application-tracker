    ...
    return (
        <form is="form-element" id={ID_FORM_COMPONENT} class="h-full pt-6 w-full" method="dialog" data-path={API_ADMIN_JOB_APPLICATION_PATH}>
            ...
            <fieldset class="max-h-svh -mb-40 overflow-y-auto pb-40 px-6 space-y-6" tabindex={-1}>
                ...
                <Textarea id="company_name" label="Company Name" aria-required="true" placeholder="Write a company_name here..." />
                <Textarea id="company_website" label="Company Website" aria-required="true" placeholder="Write a company_website here..." />
