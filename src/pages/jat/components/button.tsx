...
export function Button({
    ...
    const colors: Record<Color, string> = {
        ...
        default: "bg-slate-950 text-white hover:bg-slate-700",
    };
    ...
    const variants: Record<Variant, string> = {
        ...
        transparent: "",
        "transparent-lg": "text-base",
        "transparent-md": "text-sm",
        "transparent-sm": "text-xs",
        circle: `rounded-full p-1.5 ${colors[color as Color]}`,
    ...
    if (variant === "circle") {
        return (
            <button {...props} className={variants[variant as Variant]} type="button">
