...
import { APPLICATIONS_PAGE } from "./constants";
...
export async function handleRequest(req: Request) {
    ...
    const filterNameHashed = (await getNameHashed("dist/jat/island/filter.island.js")) as string;
                                                ...
                                                {result.map((application, index) => (
                                                    <tr key={application.uuid} class="border-b" data-state="false">
                                                        ...
                                                        <td class="p-2 align-middle">
                                                            <a href={`${APPLICATIONS_PAGE}/${application.uuid}`}>
