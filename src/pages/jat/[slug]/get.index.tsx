...
import { PAGE_JOB_APPLICATIONS_EDIT_PAGE_PATH } from "@/config/shared/jat.constants";
...
export async function handleRequest(req: Request) {
    try {
        ...
        const deleteNameHashed = (await getNameHashed("dist/[slug]/island/delete.island.js")) as string;
                                ...
                                <div class="p-4 relative space-y-1">
                                    <div class="md:absolute top-4 right-4 mb-4 flex items-center">
                                        <ul class="flex-shrink-0 flex space-x-2 items-center">
                                            <li>
                                                <Button tag="a" href={`${PAGE_JOB_APPLICATIONS_EDIT_PAGE_PATH}/${uuid}`}>
