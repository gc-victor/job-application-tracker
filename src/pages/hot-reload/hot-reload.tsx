    ...
    return IS_DEVELOPMENT ? (
        <script
            ...
            dangerouslySetInnerHTML={{
                __html: js`
    window.customElements.define = (function(originalDefine) {
        return function(tagName, elementClass, options) {
            if (!customElements.get(tagName)) {
                originalDefine.call(customElements, tagName, elementClass, options);
            } else {
                console.warn('Custom element already defined:', tagName);
                // location.reload();
            }
        };
