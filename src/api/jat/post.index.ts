...
import { JOB_APPLICATION_DATABASE, PAGE_JOB_APPLICATIONS_PAGE_PATH } from "@/config/shared/jat.constants";
...
export async function handleRequest(req: Request): Promise<Response> {
    try {
        ...
        return Response.redirect(`${url.origin + PAGE_JOB_APPLICATIONS_PAGE_PATH}/${uuid}`, SEE_OTHER_CODE);
    } catch (e) {
