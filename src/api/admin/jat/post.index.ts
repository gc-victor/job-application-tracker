...
export async function handleRequest(req: Request): Promise<Response> {
    try {
        ...
        const query =
            "INSERT INTO job_application (position, job_link, company_name, company_website, location, salary_range_min, salary_range_max, job_type, workplace, status, tags, notes, documents) VALUES (:position, :job_link, :company_name, :company_website, :location, :salary_range_min, :salary_range_max, :job_type, :workplace, :status, :tags, :notes, :documents);";
        const params = {
            ":position": position,
            ":job_link": jobLink,
            ":company_name": companyName,
