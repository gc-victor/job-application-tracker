...
// Pages
export const PAGE_JOB_APPLICATIONS_PAGE_PATH = "/jat";
export const PAGE_JOB_APPLICATIONS_ADD_PAGE_PATH = "/jat/add";
export const PAGE_JOB_APPLICATIONS_EDIT_PAGE_PATH = "/jat/edit";
